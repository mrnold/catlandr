...
extern const unsigned char img_lander[];
extern const unsigned char img_downcrash[];
extern const unsigned char img_leftcrash[];
extern const unsigned char img_rightcrash[];
